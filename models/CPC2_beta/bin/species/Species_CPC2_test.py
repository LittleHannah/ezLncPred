...
lncRNA = list(SeqIO.parse("/home/ls1/data/CPPred_data/Zebrafish/Zebrafish_ncrna.fa","fasta"))
pcts = list(SeqIO.parse("/home/ls1/data/CPPred_data/Zebrafish/Zebrafish_coding_RNA.fa","fasta"))
...
output_file = "CPC2_result"

print("CPC2 is Running ... ")
os.system("python2 /home/ls1/CPC2-beta/bin/CPC2.py -i "+test_file+" -o "+output_file)
