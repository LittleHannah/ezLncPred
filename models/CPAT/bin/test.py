...
#lncRNA = list(SeqIO.parse("/home/ls1/Extract_features/test_lncrna.fa","fasta"))
#pcts = list(SeqIO.parse("/home/ls1/Extract_features/test_pct.fa","fasta"))
#lncRNA = lncRNA[:1000]
#pcts = pcts[:1000]
...
def crossValidation(all_X, global_y,folds):
	...
	#train
        ...
        CPAT_model_train(train_X_lncRNA_path,train_X_pcts_path,'Mouse')
